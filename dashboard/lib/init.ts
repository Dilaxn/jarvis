  ...
  const apps = [
    {
      ...
      repo: 'Dilaxn/jarvis',
      domain: process.env.DASHBOARD_DOMAIN ?? 'ops.example.com',
    ...
    },
    {
      ...
      domain: process.env.LANKA_NEWS_DOMAIN ?? 'lankanews.example.com',
    ...
    },
    {
      ...
      domain: process.env.INVITATION_DOMAIN ?? 'invite.example.com',
    ...
    },
    {
      ...
      display_name: 'PMS',
      repo: 'Dilaxn/pms',
      domain: process.env.PMS_DOMAIN ?? 'pms.example.com',
    ...
    },
    {
      ...
      display_name: 'Prince',
      repo: 'Dilaxn/prince',
      domain: process.env.PRINCE_DOMAIN ?? 'prince.example.com',
    ...
    },
    {
      ...
      domain: process.env.WEBPULSE_DOMAIN ?? 'webpulse.example.com',
